    ...
    vec![
        ...
        AlgorithmEntry {
            ...
            params: vec![
                ParamDef {
                    name: "flatness",
                    label: "Flatness Threshold (\u{00b0})",
                    kind: ParamKind::Float {
                        default: 1.0,
                        min: 0.0,
                        max: 10.0,
        ...
        AlgorithmEntry {
            ...
            input_count: 1,
            params: vec![param_radius(10, 200)],
        },
        AlgorithmEntry {
            id: "landform",
            name: "Landform Classification",
            category: AlgoCategory::Terrain,
        ...
        AlgorithmEntry {
            ...
            input_count: 1,
            params: vec![param_radius(1, 50)],
        },
        AlgorithmEntry {
            id: "vrm",
            name: "VRM (Vector Ruggedness Measure)",
            category: AlgoCategory::Terrain,
        ...
        AlgorithmEntry {
            id: "erode",
            name: "Erosion",
            category: AlgoCategory::Morphology,
            description: "Morphological erosion (minimum filter)",
            input_count: 1,
            params: vec![param_se_shape(), param_radius(1, 20)],
        },
        AlgorithmEntry {
            id: "dilate",
            name: "Dilation",
        ...
        // ═══════════════════════════════════════════════════════
        AlgorithmEntry {
            id: "breach_depressions",
            name: "Breach Depressions",
            category: AlgoCategory::Hydrology,
        ...
        AlgorithmEntry {
            id: "flow_direction_dinf",
            name: "Flow Direction (D-inf)",
            category: AlgoCategory::Hydrology,
        ...
        AlgorithmEntry {
            id: "flow_accumulation_mfd_adaptive",
            name: "Flow Accumulation (Adaptive MFD)",
            category: AlgoCategory::Hydrology,
        ...
        AlgorithmEntry {
            id: "flow_accumulation_tfga",
            name: "Flow Accumulation (TFGA)",
            category: AlgoCategory::Hydrology,
        ...
        AlgorithmEntry {
            id: "nested_depressions",
            name: "Nested Depressions",
            category: AlgoCategory::Hydrology,
        ...
        AlgorithmEntry {
            id: "flow_dinf",
            name: "D-inf Flow (Direction + Accumulation)",
            category: AlgoCategory::Hydrology,
        ...
        AlgorithmEntry {
            ...
            name: "Normalized Difference (custom)",
            category: AlgoCategory::Imagery,
        ...
        AlgorithmEntry {
            id: "sti",
            name: "STI (Sediment Transport Index)",
            category: AlgoCategory::Terrain,
            ...
            params: vec![
                ...
                ParamDef {
                    name: "n",
                    label: "n (slope steepness exponent)",
                    kind: ParamKind::Float {
                        default: 1.3,
                        min: 0.0,
                        max: 5.0,
        ...
        AlgorithmEntry {
            ...
            params: vec![
                ...
                ParamDef {
                    name: "max_radius",
                    label: "Max Radius (cells, 0=unlimited)",
                    kind: ParamKind::Int {
                        default: 0,
                        min: 0,
                        max: 100000,
        ...
        AlgorithmEntry {
            id: "advanced_curvatures",
            name: "Advanced Curvatures (Florinsky)",
            category: AlgoCategory::Terrain,
        ...
        AlgorithmEntry {
            ...
            category: AlgoCategory::Interpolation,
